      ...
      <div className="min-h-screen bg-gray-50">
        <div className="p-4 max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl font-bold mb-4">
            Investigating: {labelMap[investigationType] || investigationType}
          </h1>
          ...
          <p className="text-xs text-gray-500 mt-4 text-center">
            <strong>Ethical Use Notice:</strong> This tool only uses passive, public,
            permission-based checks. It does not attack, scan, exploit, bypass access
            controls, or access private systems.
          </p>
        </div>
      </div>
    );
